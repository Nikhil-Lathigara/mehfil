...
export const playlists = {
  playlistA: {
    name: 'Golden Hits',
    image: '/bg/scene-wide.png',
    bg: { wide: '/bg/scene-wide.png', tall: '/bg/scene-tall.png' },
    tint: 'rgba(255, 140, 60, 0.30)',
    tracks: [
      { id: 1, title: 'Walk on Sunshine', artist: 'Katrina & The Waves', film: '', year: 1985, duration: 198, src: '/songs/walk-on-sunshine.mp3' },
      { id: 2, title: 'Sweet Dreams', artist: 'Eurythmics', film: '', year: 1983, duration: 215, src: '/songs/sweet-dreams.mp3' },
      { id: 3, title: 'Take On Me', artist: 'A-ha', film: '', year: 1985, duration: 225, src: '/songs/take-on-me.mp3' }
    ]
  },
  playlistB: {
    name: 'Midnight Jams',
    image: '/bg/scene-wide.png',
    bg: { wide: '/bg/scene-wide.png', tall: '/bg/scene-tall.png' },
    tint: 'rgba(70, 120, 255, 0.30)',
    tracks: [
      { id: 1, title: 'Midnight City', artist: 'M83', film: '', year: 2011, duration: 244, src: '/songs/midnight-city.mp3' },
      { id: 2, title: 'Dreams', artist: 'Fleetwood Mac', film: '', year: 1977, duration: 257, src: '/songs/dreams.mp3' },
      { id: 3, title: 'Electric Feel', artist: 'MGMT', film: '', year: 2008, duration: 229, src: '/songs/electric-feel.mp3' }
    ]
  },
  playlistC: {
    name: 'Sunday Drive',
    image: '/bg/scene-wide.png',
    bg: { wide: '/bg/scene-wide.png', tall: '/bg/scene-tall.png' },
    tint: 'rgba(60, 220, 150, 0.30)',
    tracks: [
      { id: 1, title: 'Life Is a Highway', artist: 'Tom Cochrane', film: '', year: 1991, duration: 266, src: '/songs/life-is-a-highway.mp3' },
      { id: 2, title: 'Home', artist: 'Edward Sharpe', film: '', year: 2010, duration: 237, src: '/songs/home.mp3' },
      { id: 3, title: 'Mr. Brightside', artist: 'The Killers', film: '', year: 2003, duration: 222, src: '/songs/mr-brightside.mp3' }
    ]
  },
  playlistD: {
    name: 'Coffeehouse',
